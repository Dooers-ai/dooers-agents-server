...
if TYPE_CHECKING:
    from dooers.agents.server.registry import ConnectionRegistry, WebSocketProtocol
...
class SettingsBroadcaster:
    ...
    async def broadcast_snapshot_to_ws(
        ...
        from dooers.agents.server.protocol.frames import S2C_SettingsSnapshot, SettingsSnapshotPayload
    ...
    async def broadcast_patch(
        ...
        from dooers.agents.server.protocol.frames import S2C_SettingsPatch, SettingsPatchBroadcastPayload
