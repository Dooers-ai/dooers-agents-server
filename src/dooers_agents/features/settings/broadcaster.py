...
if TYPE_CHECKING:
    from dooers_agents.registry import ConnectionRegistry, WebSocketProtocol
...
class SettingsBroadcaster:
    ...
    async def broadcast_snapshot_to_ws(
        ...
        from dooers_agents.protocol.frames import S2C_SettingsSnapshot, SettingsSnapshotPayload
    ...
    async def broadcast_patch(
        ...
        from dooers_agents.protocol.frames import S2C_SettingsPatch, SettingsPatchBroadcastPayload
