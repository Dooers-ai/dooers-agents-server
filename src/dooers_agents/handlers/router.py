...
from dooers_agents.features.settings.models import SettingsFieldVisibility
from dooers_agents.handlers.pipeline import Handler, HandlerContext, HandlerPipeline, UploadReferenceError
...
from dooers_agents.protocol.parser import serialize_frame
...
class Router:
    ...
    async def _handle_thread_delete(self, ws: WebSocketProtocol, frame: C2S_ThreadDelete) -> None:
        ...
        if self._agent_config:
            try:
                from dooers_agents.storage.chat_artifacts import delete_chat_artifacts_for_thread
