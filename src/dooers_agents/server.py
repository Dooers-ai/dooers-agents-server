...
from dooers_agents.protocol.models import Thread, ThreadEvent, User, WireC2S_ContentPart
from dooers_agents.protocol.parser import parse_frame, serialize_frame
from dooers_agents.registry import ConnectionRegistry
from dooers_agents.repository import Repository
from dooers_agents.settings import (
...
class AgentServer:
    ...
    async def _hydrate_thread_events_impl(
        ...
        from dooers_agents.storage.hydrate import hydrate_thread_events
    ...
    def _resolve_whatsapp_outbound(self, persistence: Persistence) -> Any:
        if not self._config.dooers_whatsapp_service:
            return None
        from dooers_agents.features.channels.whatsapp.outbound import create_dooers_whatsapp_outbound
    ...
    async def chat_upload(
        ...
        *,
        ...
        from dooers_agents.storage.chat_artifacts import chat_storage_service_ready, put_chat_artifact
    ...
    async def _ensure_initialized(self) -> Persistence:
        ...
        if self._config.database_type == "cosmos":
            from dooers_agents.persistence.cosmos import CosmosPersistence
